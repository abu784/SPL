...
$mobile = $_GET['id'];
$team = "SELECT * FROM teams WHERE mobile = '$mobile'";
$res = $conn->query($team);
$teams = $res->fetch_assoc();
$id = $teams['id'];
?>
...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="userdashboard.php" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">SMART REACH</span> </a>
                <div class="nav_list"> <a href="userdashboard.php" class="nav_link "> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a>
                            <a href="#" class="nav_link active"> <i class='bx bx-message-square-detail nav_icon'></i> <span class="nav_name">TEAMS</span> </a> 
...
require "../includes/dbconnect.php";
        ...
        $players = "SELECT * FROM players WHERE team_id = '$id'";
        $play_res = $conn->query($players);
?>
...
<table class="table">
    ...
    <tbody>
    <?php while ($row = $play_res->fetch_assoc()) { ?>
        <tr>
